...
- Ceci est un plugin pour [LifeOS](https://lifeos.vip), qui aide à pratiquer la méthode PARA avec des notes périodiques et [usememos](https://www.usememos.com/).
- Il est recommandé de télécharger [LifeOS-example](https://github.com/quanru/obsidian-example-lifeos/releases/latest/download/LifeOS_FR.zip) pour l'essayer.
- Pour plus de tutoriels, rendez-vous sur [Site Officiel LifeOS pour Obsidian](https://lifeos.vip/fr/)

![](https://obsidian-life-os.pages.dev/plugin/periodic-para-plugin-en.png)

## Fonctionnalités

- LifeOS Basic: https://lifeos.vip/fr/plugin/lifeos/life-os.html
- **LifeOS Pro** : https://lifeos.vip/fr/plugin/lifeos/life-os-pro.html
- **DeepAsk AI for Obsidian** : https://lifeos.vip/fr/plugin/deepask/deepask.html
...
J'ai également utilisé le code de ces excellents plugins :
...
Si ce plugin vous aide, offrez-moi un café sur [buymeacoffee](https://www.buymeacoffee.com/leyang).

In addition, you can also support me in further developing a better LifeOS by purchasing the [LifeOS Pro](https://lifeos.vip/fr/plugin/life-os-pro.html)!
