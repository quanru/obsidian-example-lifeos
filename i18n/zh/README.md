...
- 这是一个专为 [LifeOS](https://lifeos.vip/zh/zh) 开发的 Obsidian 插件，可通过『周期笔记』和『[usememos](https://www.usememos.com/)』来实践 PARA 方法。
- 强烈推荐下载 [LifeOS-example](https://github.com/quanru/obsidian-example-lifeos/releases/latest/download/LifeOS_ZH.zip) 示例仓库来体验本插件。
- 更多教程，请访问[Obsidian LifeOS 官网](https://lifeos.vip/zh/zh)查看

![](https://lifeos.vip/zh/plugin/periodic-para-plugin.png)
...
- [LifeOS-example](https://github.com/quanru/obsidian-example-lifeos/releases/latest/download/LifeOS_ZH.zip)
