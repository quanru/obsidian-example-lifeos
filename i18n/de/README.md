...
- Dies ist ein Plugin für [LifeOS](https://lifeos.vip), das bei der Anwendung der PARA-Methode mit periodischen Notizen und [usememos](https://www.usememos.com/).
- Es wird empfohlen, das [LifeOS-example](https://github.com/quanru/obsidian-example-lifeos/releases/latest/download/LifeOS_DE.zip) um es auszuprobieren.
- Weitere Tutorials finden Sie auf der [LifeOS für Obsidian Offizielle Website](https://lifeos.vip/de/)

![](https://obsidian-life-os.pages.dev/plugin/periodic-para-plugin-en.png)

## Funktionen

- LifeOS Basic: https://lifeos.vip/de/plugin/lifeos/life-os.html
- **LifeOS Pro** : https://lifeos.vip/de/plugin/lifeos/life-os-pro.html
- **DeepAsk AI for Obsidian** : https://lifeos.vip/de/plugin/deepask/deepask.html
- **DeepAsk AI for Chrome** : https://chromewebstore.google.com/detail/deepask-ai/abhoenehflglmgbohaibihggedfcpcep

## Herunterladen

- [LifeOS-example](https://github.com/quanru/obsidian-example-lifeos/releases/latest/download/LifeOS_DE.zip)
...
Außerdem habe ich auf den Code dieser hervorragenden Plugins aufgebaut:
...
Wenn dieses Plugin Ihnen hilft, spendieren Sie mir bitte einen Kaffee auf [buymeacoffee](https://www.buymeacoffee.com/leyang).

In addition, you can also support me in further developing a better LifeOS by purchasing the [LifeOS Pro](https://lifeos.vip/de/plugin/life-os-pro.html)!
