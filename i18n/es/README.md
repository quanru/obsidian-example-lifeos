...
- Este es un plugin para [LifeOS](https://lifeos.vip), que ayuda a practicar el método PARA con notas periódicas y [usememos](https://www.usememos.com/).
- Se recomienda descargar [LifeOS-example](https://github.com/quanru/obsidian-example-lifeos/releases/latest/download/LifeOS_ES.zip) para experimentarlo.
- Para más tutoriales, visite [Sitio Oficial de LifeOS para Obsidian](https://lifeos.vip/es/)

![](https://obsidian-life-os.pages.dev/plugin/periodic-para-plugin-en.png)

## Características

- LifeOS Basic: https://lifeos.vip/es/plugin/lifeos/life-os.html
- **LifeOS Pro** : https://lifeos.vip/es/plugin/lifeos/life-os-pro.html
- **DeepAsk AI for Obsidian** : https://lifeos.vip/es/plugin/deepask/deepask.html
