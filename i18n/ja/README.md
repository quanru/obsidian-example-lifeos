...
- これは [LifeOS](https://lifeos.vip)のプラグインで、定期ノートと [usememos](https://www.usememos.com/).
- It is recommended to download the [LifeOS-example](https://github.com/quanru/obsidian-example-lifeos/releases/latest/download/LifeOS_JA.zip) をダウンロードして体験することをお勧めします。
- 詳しいチュートリアルは [LifeOS for Obsidian 公式サイト](https://lifeos.vip/ja/)

![](https://obsidian-life-os.pages.dev/plugin/periodic-para-plugin-en.png)

## 機能

- LifeOS Basic: https://lifeos.vip/ja/plugin/lifeos/life-os.html
- **LifeOS Pro** : https://lifeos.vip/ja/plugin/lifeos/life-os-pro.html
- **DeepAsk AI for Obsidian** : https://lifeos.vip/ja/plugin/deepask/deepask.html
- **DeepAsk AI for Chrome** : https://chromewebstore.google.com/detail/deepask-ai/abhoenehflglmgbohaibihggedfcpcep

## ダウンロード

- [LifeOS-example](https://github.com/quanru/obsidian-example-lifeos/releases/latest/download/LifeOS_JA.zip)
...
このプラグインがお役に立ちましたら、ぜひ [buymeacoffee](https://www.buymeacoffee.com/leyang).

In addition, you can also support me in further developing a better LifeOS by purchasing the [LifeOS Pro](https://lifeos.vip/ja/plugin/life-os-pro.html)!
