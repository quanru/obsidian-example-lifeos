...
- Este é um plugin para [LifeOS](https://lifeos.vip), que auxilia na prática do método PARA com notas periódicas e [usememos](https://www.usememos.com/).
- Recomenda-se baixar o [LifeOS-example](https://github.com/quanru/obsidian-example-lifeos/releases/latest/download/LifeOS_PT.zip) para experimentar.
- Para mais tutoriais, acesse [Site Oficial do LifeOS para Obsidian](https://lifeos.vip/pt/)

![](https://obsidian-life-os.pages.dev/plugin/periodic-para-plugin-en.png)

## Funcionalidades

- LifeOS Basic: https://lifeos.vip/pt/plugin/lifeos/life-os.html
- **LifeOS Pro** : https://lifeos.vip/pt/plugin/lifeos/life-os-pro.html
- **DeepAsk AI for Obsidian** : https://lifeos.vip/pt/plugin/deepask/deepask.html
- **DeepAsk AI for Chrome** : https://chromewebstore.google.com/detail/deepask-ai/abhoenehflglmgbohaibihggedfcpcep

## Download

- [LifeOS-example](https://github.com/quanru/obsidian-example-lifeos/releases/latest/download/LifeOS_PT.zip)
...
Além disso, contei com o código destes excelentes plugins:
...
Se este plugin te ajudou, por favor me pague um café no [buymeacoffee](https://www.buymeacoffee.com/leyang).

In addition, you can also support me in further developing a better LifeOS by purchasing the [LifeOS Pro](https://lifeos.vip/pt/plugin/life-os-pro.html)!
