...
- [ ] 21: 32 有一个 Obsidian 插件的 idea：同步任务到滴答清单提醒，一种简单的方法通过邮箱添加任务，另一种方式就是参考这个插件的 open api #PARA/捕获
	...
	- [GitHub - eightHundreds/obsidian-dida-sync: 滴答清单同步到obsidian(ticktick sync to obsidian)](https://github.com/eightHundreds/obsidian-dida-sync) #知识管理/PARA/捕获 ^y73alp
